...
import com.example.controller.FormAddBookController;
...
public class FormAddBook extends JFrame {
    ...
    // Controller
    private FormAddBookController controller;
    
    // Sách được truyền vào nếu là chế độ sửa/copy
    ...
    public FormAddBook(Sach sach) {
        ...
        controller = new FormAddBookController(this, sachDAO, danhMucSachDAO);
    ...
    private void initComponents() {
        ...
        titleLabel = new JLabel(isEditMode ? "Sửa thông tin sách" : "Thêm sách mới");
