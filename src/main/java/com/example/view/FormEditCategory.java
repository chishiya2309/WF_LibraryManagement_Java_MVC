...
import com.example.controller.FormEditCategoryController;

public class FormEditCategory extends JDialog {
    // Colors
    ...
    private FormEditCategoryController controller;
    private String categoryId;
    private boolean successful = false;
    
    // Data
    private Map<Integer, String> indexToCategoryId;

    public FormEditCategory(String categoryId) {
        // Set up the dialog
        ...
        this.indexToCategoryId = new HashMap<>();
        ...
        controller = new FormEditCategoryController(this, danhMucSachDAO);
    ...
    private void initComponents() {
        ...
        titleLabel = new JLabel("Chỉnh sửa danh mục");
        ...
        // Make category ID field read-only
        categoryIdField.setEditable(false);
        categoryIdField.setBackground(new Color(240, 240, 240));
    ...
    public Map<Integer, String> getIndexToCategoryId() {
        return indexToCategoryId;
    }

    public void setIndexToCategoryId(Map<Integer, String> indexToCategoryId) {
        this.indexToCategoryId = indexToCategoryId;
    }
}